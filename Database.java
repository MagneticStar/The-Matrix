...
public class Database {
     ...
     // Parameters
          ...
          public final static int startingFoodCount = 1000; // how many foods should be initially created
          ...
          public final static int generationLength = 200; // How many ticks each generation is
          public final static int simulationLength = 1000; // How many generations there should be

          public final static int worldSize = 128; // The size of the square world

          public final static int repoductionPerCreature = 1; // the amount of creatures a creature makes when reproducing
